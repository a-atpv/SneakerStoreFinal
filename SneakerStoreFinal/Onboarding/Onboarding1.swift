...
class Onboarding1: UIViewController {
    ...
    var nextView = Onboarding2()
    var firstSneaker: UIImageView = ImageFactory.Image(name: "image 1", isHidden: false)
    var secondSneaker: UIImageView = ImageFactory.Image(name: "image 2", isHidden: false)
    var vector1: UIImageView = ImageFactory.Image(name: "Vector 1", isHidden: false)
